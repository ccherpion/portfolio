...
function render() {
            ...
            <div class="reveal-block framer-card group relative rounded-3xl overflow-hidden aspect-[4/3] border border-gray-200 dark:border-darkBorder">
                ...
                <div class="project-gradient absolute inset-0 flex flex-col justify-end p-8 text-white">
                    <div class="transform translate-y-6 group-hover:translate-y-0 transition-transform duration-500">
                        ...
                        <div class="bg-black/50 backdrop-blur-md border border-white/10 rounded-xl p-4 mb-4 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                            <p class="text-gray-200 text-xs leading-relaxed line-clamp-2">${p.desc}</p>
                        </div>

                        <div class="flex justify-between items-center">
                            <span class="badge-blue !bg-white/10 !text-white !border-white/20 text-[10px] font-bold px-4 py-2 rounded-full font-tech uppercase shadow-lg">${p.tag}</span>
    ...
    // RÉINTÉGRATION COMPLÈTE DE LA PAGE EXPÉRIENCES (my.path)
    if (d.experiences) {
